 ...
 */
public class GenerateThreeKDataSet {

    private String outputFolder = "src/test/resources/codes/output/all/";
    private int start, end;

    public GenerateThreeKDataSet(int start, int end) {
        this.start = start;
        this.end = end;
    }
    ...
    public void run() {
        ...
        List<String> kDiseases = ReadTXTFile.readTxtFile("k_diseases_codes.txt");
        // Remove headers
        kDiseases.remove(0);
    ...
    private void generateThreeDiseasesSentences(String outputFile, List<String> diseases) {
